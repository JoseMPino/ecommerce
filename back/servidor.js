...
const conectarBDMongo = require('./src/config/baseDatos'); // MongoDB
const pool = require('./src/config/baseDatosPosSql'); // Importamos el pool directamente
const middlewareAutenticacion = require('./src/middleware/middlewareAutentication');
